...
export class SessionManager {
  ...
  async login(credential){const result=await this.api.call('auth.login',{credential});this.generation++;this.state={...result,status:'authenticated'};this.persist();this.emit();return this.snapshot();}
