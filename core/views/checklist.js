...
(() => {
  ...
  function reportItemGroup(item,day){const record=displayRecord(item);if(record?.condition==='NAO')return 0;if(isInactiveMaintenance(item,day))return 2;return 1;}
